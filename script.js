/* ==========================================
   GREETWELL GROUP - COMPLETE LUXURY JS
   All Pages Included (Home, About, Products, Services, Contact)
   ========================================== */
...
function initScrollAnimations() {
    ...
    const fadeElements = document.querySelectorAll(
        ...
        '.luxury-stat-card, .testimonial-luxury-card, .highlight-item, ' +
        '.mission-box, .team-member-card, .cert-card, .service-card-luxury, ' +
        '.process-step-card, .faq-item-luxury'
    );
...
function initCursorEffect() {
    ...
    const interactiveElements = document.querySelectorAll(
        ...
        '.team-member-card, .cert-card, .service-card-luxury'
    );
...
document.addEventListener('DOMContentLoaded', function() {
    const cards = document.querySelectorAll(
        ...
        '.testimonial-luxury-card, .luxury-stat-card, .team-member-card, ' +
        '.cert-card, .service-card-luxury'
    );
...
document.addEventListener('DOMContentLoaded', function() {
    const filterButtons = document.querySelectorAll('.filter-btn-luxury');
